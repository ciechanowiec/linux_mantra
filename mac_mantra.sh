...
if [ "$isLinux" == true ] && [ "$isMacOS" == false ];
  then
    ...
    then
      echo "TEMPORARY DISABLED UPDATES"
      #TODO: restore from comment
...
# echo "Installing mpv (.djvu files viewer)..."
...
# cp -v "$resourcesDir/mac/defaults/HOME/Library/Preferences/com.lwouis.alt-tab-macos.plist" "$HOME/Library/Preferences/com.lwouis.alt-tab-macos.plist"
...
#
#echo "3. Configuring Colima to be launched on system startup..."
...
#
#echo "4. Defining the Colima template file to increase default RAM allocation..."
## The only adjustment compared to the default template is increased RAM allocation
...
#
#echo "5. Installing Docker Buildx..."
...
##                                                                             #
################################################################################
#procedureId="default browser"
## DOCUMENTATION:
##   https://www.felixparadis.com/posts/how-to-set-the-default-browser-from-the-command-line-on-a-mac/
#
#informAboutProcedureStart
#
#echo "Downloading the application required to set up the default browser..."
#brew install defaultbrowser
#sleep 3 # Give some time to finish installation
#
#echo "Setting Chrome as a default browser..."
#defaultbrowser chrome //TODO: edge
#
#informAboutProcedureEnd
#
#promptOnContinuation
...
#echo "   2.1. Uncheck the checkbox 'Automatically adjust brightness'"
#echo "   2.2. Go to 'Advanced...' and uncheck the checkbox 'Slightly dim the display on battery'"
...
#sudo cp -R "/Volumes/Paint X/Paint X.app" "$HOME/Applications"
